...
# Uses dockerized protoc to keep local environment clean. Requires Docker.
# Generates Go types, gRPC stubs, grpc-gateway, and OpenAPI swagger (merged into airbooking.swagger.json).
